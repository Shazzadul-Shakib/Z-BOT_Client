...
const FeatureCard = ({ feature }) => {
  ...
  const {data:allTasks}=useGetAllTasksQuery({projectId:projectId,featureId:_id});
          ...
          <div className="mb-2">
            <div className="flex items-center">
              ...
              <h3 className="text-sm font-semibold">
                Modules - {allTasks?.data?.length}
              </h3>
            </div>
            <div className="flex items-center my-2">
              <CheckCircle size={16} className="text-primary mr-2" />
              <h3 className="text-sm font-semibold">Completed - 0</h3>
            </div>
          </div>
