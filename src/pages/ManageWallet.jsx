...
const ManageWallet = () => {
  ...
  const [deleteWallet, { isLoading: deleteWalletLoading }] =
    useDeleteWalletMutation();

  if (isLoading || deleteWalletLoading) {
  ...
  const handleDeleteWallet = async (walletId) => {
    await deleteWallet({ walletOwnerId: user._id, walletId });
  };
  return (
    <div>
      <Card>
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        >
                          <DropdownMenuItem
                            className="rounded cursor-pointer"
                            onClick={() => handleDeleteWallet(item._id)}
                          >
                            Delete
                          </DropdownMenuItem>
                        </DropdownMenuContent>
